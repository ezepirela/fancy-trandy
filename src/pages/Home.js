            ...
            <Carousel activeIndex={index} onSelect={handleSelect}>
                <Carousel.Item>
                    <img
                      ...
                      src="https://www.importadoracrisma.com/wp-content/uploads/2021/01/PALETA-HUDABEAUTY-NEON.jpg"
                      alt="First slide"
                    />
                    <Carousel.Caption className='home__carouselCaptionTitle'>
                        <h3>Naughty Nude Pallete</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item className='home__carouselItem'>
                    <img
                      className="d-block w-100"
                      src="https://www.yoquieromayorista.com/wp-content/uploads/2020/10/WhatsApp-Image-2020-10-12-at-16.48.38-1.jpeg"
                      alt="Second slide"
                    />
                    <Carousel.Caption id='home__carouselCaptionTitle2'>
                        <h3>Over Highlighting Powder</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
                      className="d-block w-100 "
                      src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/ma-scara-huda-beauty-1590049277.jpg"
                      alt="Third slide"
                    />
                    <Carousel.Caption className='home__carouselCaptionTitle'>
                        <h3>Legit Lashes</h3>
